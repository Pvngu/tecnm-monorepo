...
export const PeriodoSchema = z.object({
    nombre: z.string({ message: 'El nombre del periodo es requerido' }).min(1, 'El nombre es requerido'),
    fecha_inicio: z.string({ message: 'La fecha de inicio es requerida' }).min(1, 'La fecha de inicio es requerida'),
    fecha_fin: z.string({ message: 'La fecha de fin es requerida' }).min(1, 'La fecha de fin es requerida'),
...
export const PeriodoFormConfig: FormFieldConfig[] = [
    { name: 'nombre', label: 'Nombre', type: 'text', placeholder: 'Ingresa el nombre del periodo' },
    ...
    { name: 'activo', label: 'Activo', type: 'text', placeholder: 'true | false' },
];

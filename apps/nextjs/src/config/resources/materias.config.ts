...
export const MateriaSchema = z.object({
    nombre: z.string({ message: 'El nombre de la materia es requerido' }).min(1, 'El nombre es requerido'),
...
export const MateriaFormConfig: FormFieldConfig[] = [
    { name: 'nombre', label: 'Nombre', type: 'text', placeholder: 'Ingresa el nombre de la materia' },
    { name: 'codigo_materia', label: 'Código', type: 'text', placeholder: 'Código de la materia (opcional)' },
    { name: 'creditos', label: 'Créditos', type: 'number', placeholder: '0' },
];

...
export const ProfesorSchema = z.object({
    ...
    apellido_paterno: z.string({ message: 'El apellido paterno es requerido' }).min(1, 'El apellido paterno es requerido'),
...
export const ProfesorFormConfig: FormFieldConfig[] = [
    ...
    { name: 'rfc', label: 'RFC', type: 'text', placeholder: 'Ingresa el RFC (opcional)' },
];
